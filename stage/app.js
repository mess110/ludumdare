...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var BloodParticle, GameScene, camera, jm, loadingScene, objs, tm, vj;
    rainbow = new Rainbow();
    ...
    GameScene = (function(superClass) {
      ...
      GameScene.prototype.toggleDrapes = function() {
        var count, fullscreen, help, highscore, menu, score;
    ...
    objs = ['./models/diffuse.png', './models/bear.png', './models/bear_all.json', './models/bunny.png', './models/bunny_all.json', './models/shotgun.png', './models/shotgun.json', './models/drapes.png', './models/drapes.json', './models/drapes2.json', './models/theater_mask.png', './models/theater_mask.json', './imgs/splatter.png', './imgs/star.png'];
